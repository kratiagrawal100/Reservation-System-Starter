...
public class Runner {
    ...
    static List<Object> aircrafts = Arrays.asList(
            new PassengerPlane().createPlane("A380"),
            new PassengerPlane().createPlane("A350"),
            new PassengerPlane().createPlane("Embraer 190"),
            new PassengerPlane().createPlane("Antonov AN2"),
            new Helicopter("H1"),
